...
test_img=cv2.imread("E:\\TRY ON VIRTUAL SOFTWARE\\Step 1 Face Recognition\\test\\33.jpg")#test_img path
...
name={0:"Hande", 1:"Feroze"}#creating dictionary containing names for each label
